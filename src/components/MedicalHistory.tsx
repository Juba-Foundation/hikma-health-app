...
export const MedicalHistoryDisplay = (metadataObj, language) => {
  return (
    <View>
      ...
      <Text>
        {LocalizedStrings[language].allergies}: {metadataObj.allergies}{' '}
      </Text>
      <Text>
        {LocalizedStrings[language].surgeryHx}: {metadataObj.surgeryHx}
      </Text>
      <Text>
        {LocalizedStrings[language].chronicConditions}:{' '}
        {metadataObj.chronicConditions}
      </Text>
      <Text>
        {LocalizedStrings[language].currentMedications}:{' '}
        {metadataObj.currentMedications}
      </Text>
      <Text>
        {LocalizedStrings[language].vaccinations}: {metadataObj.vaccinations}
      </Text>
    </View>
  );
};
...
const MedicalHistory = (props: Props) => {
  ...
  useEffect(() => {
    database
      .getLatestPatientEventByType(patientId, EventTypes.MedicalHistoryFull)
      .then((response: any) => {
