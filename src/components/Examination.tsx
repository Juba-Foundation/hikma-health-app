...
export const ExaminationDisplay = (metadataObj, language) => {
  return (
    <View>
      ...
      <Text>
        {LocalizedStrings[language].examination}: {metadataObj.examination}{' '}
      </Text>
      <Text>
        {LocalizedStrings[language].generalObservations}:{' '}
        {metadataObj.generalObservations}
      </Text>
      <Text>
        {LocalizedStrings[language].diagnosis}: {metadataObj.diagnosis}
      </Text>
      <Text>
        {LocalizedStrings[language].treatment}: {metadataObj.treatment}
      </Text>
      <Text>
        {LocalizedStrings[language].covid19}:{' '}
        {formatBooleanDisplay(metadataObj.covid19, language)}
      </Text>
      <Text>
        {LocalizedStrings[language].referral}:{' '}
        {formatTextDisplay(
...
const Examination = (props: Props) => {
  ...
  const submit = async () => {
    database
      ...
      .then(() => {
        props.navigation.navigate('NewVisit', {language, userName, visitId});
      });
  };
