...
export const PhysiotherapyDisplay = (metadataObj, language) => {
  return (
    <View>
      ...
      <Text>
        {LocalizedStrings[language].previousTreatment}:{' '}
        {formatTextDisplay(
      ...
      <Text>
        {LocalizedStrings[language].complaint}: {metadataObj.complaint}{' '}
      </Text>
      <Text>
        {LocalizedStrings[language].findings}: {metadataObj.findings}
      </Text>
      <Text>
        {LocalizedStrings[language].treatmentPlan}: {metadataObj.treatmentPlan}
      </Text>
      <Text>
        {LocalizedStrings[language].treatmentSession}:{' '}
        {metadataObj.treatmentSession}
      </Text>
      <Text>
        {LocalizedStrings[language].recommendations}:{' '}
        {metadataObj.recommendations}
      </Text>
      <Text>
...
const Physiotherapy = (props) => {
  ...
  useEffect(() => {
    database
      .getLatestPatientEventByType(patientId, EventTypes.Physiotherapy)
      .then((response: any) => {
