  ...
  const handleLogin = async () => {
    try {
      ...
      if (user === null || user === undefined) {
        ...
        const nameId = await database.saveStringContent(
          stringContentArray,
          responseJson.name.id,
        );
  ...
  return (
    <View style={styles.loginContainer}>
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={styles.modalText}>
              Initial sync in progress - please wait
            </Text>
          </View>
        </View>
      </Modal>
          ...
          <View style={[styles.modalView, {alignItems: 'stretch', flex: 1}]}>
            ...
            <ScrollView style={{marginTop: 10}}>
              <Text style={{fontStyle: 'italic'}}>
                Hikma Health is an independent 501(c)(3) nonprofit and is not
                affiliated with Hikma Pharmaceuticals PLC or any of its
                affiliates.
              </Text>
              ...
              <Text>
                Please read this Terms of Use statement in full before
                downloading or using the Hikma Health application
                ("Application"). By downloading or using the Application, you
                are agreeing to be bound by the terms and conditions of this
                Agreement. If you do not agree to the terms of this Agreement,
                do not download or use the Application. Hikma Health ("us",
                "we", or "our") operates the Hikma Health application
                (“Application”). This page informs you of our policies regarding
                the collection, use and disclosure of Personal Information we
                receive from users of the Application. The Application is an
                open source application and is provided by Hikma Health at no
                cost and is intended for use as is. If you choose to use our
                Application, then you agree to the collection and use of
                information in relation to this policy. The Personal Information
                that we collect is used for providing and improving the
                Application. We will not use or share your information with
              ...
              <Text>
                ...
                contact or identify you. Additionally, you may use the
                Application to collect patient health information. In this case,
                personally identifiable information may include, but is not
                limited to your name, email address, and patient health
                information ("Personal Information"). All information that is
                collected by the Application is encrypted and will not be shared
                with third parties for any reason at any time. Personal
                information that is collected will be retained by us and used as
                described in this privacy policy. The app does use third party
                services provided by Google Play Services that may collect
                information used to identify you. All data collected and used by
                third party services is described in the privacy policy of
                Google Play Services.
              </Text>
              <Text style={{fontWeight: 'bold', paddingTop: 5}}>Log Data</Text>
              <Text>
                We want to inform you that whenever you use our Application, in
                a case of an error in the delivery of services, we may collect
                data and information (through third party products) on your
                phone called Log Data. This Log Data may include information
                such as your device Internet Protocol (“IP”) address, device
                name, operating system version, the configuration of the app
                when utilizing our Application, the time and date of your use of
                the Application, and other statistics.
              </Text>
              <Text style={{fontWeight: 'bold', paddingTop: 5}}>Cookies</Text>
              <Text>
                Cookies are files with a small amount of data that are commonly
                used as anonymous unique identifiers. These are sent to your
                browser from the websites that you visit and are stored on your
                device's internal memory. This Application does not use these
                “cookies” explicitly. However, the Application may use third
                ...
                you may not be able to use some portions of this Application.
              </Text>
              <Text style={{fontWeight: 'bold', paddingTop: 5}}>
                Service Providers
              </Text>
              <Text>
                ...
                following reasons: To facilitate our Application; To provide the
                Application on our behalf; To perform Application-related
                services; or To assist us in analyzing how our Service is used.
                We want to inform users of this Application that these third
                parties may have access to your Personal Information. The reason
              ...
              <Text style={{fontWeight: 'bold', paddingTop: 5}}>Security</Text>
              <Text>
              ...
              <Text>
                This Application may contain links to other sites. If you click
              ...
              <Text>
                This Application does not address anyone under the age of 13. We
                do not knowingly collect personally identifiable information
                from children under 13. In the case we discover that a child
                under 13 has provided us with their personal information, we
              ...
              <Text>
                This Privacy Policy is effective as of October 1, 2020 and will
              ...
              <Text>
                Last updated: October 1, 2020 Please read this Terms of Use
                statement in full before downloading or using the Hikma Health
                application ("Application"). By downloading or using the
                Application, you are agreeing to be bound by the terms and
                conditions of this Agreement. If you do not agree to the terms
                of this Agreement, do not download or use the Application.
              </Text>
              <Text style={{fontWeight: 'bold', paddingTop: 5}}>License</Text>
              <Text>
                Hikma Health grants you a revocable, non-exclusive,
              ...
              <Text>
                ...
                Application or make the Application available to any third
                party.
              </Text>
              <Text style={{fontWeight: 'bold', paddingTop: 5}}>
              ...
              <Text>
                Hikma Health reserves the right to modify, suspend or
              ...
              <Text>
                ...
                Hikma Health. Hikma Health may, in its sole discretion, at any
                time and for any or no reason, suspend or terminate this
                Agreement with or without prior notice. This Agreement will
                terminate immediately, without prior notice from Hikma Health,
                ...
                Application and all copies thereof from your electronic devices.
                ...
                your mobile device or from your electronic devices.
              </Text>
              <Text style={{fontWeight: 'bold', paddingTop: 5}}>
                Severability
              </Text>
              ...
              <Text>
                Hikma Health reserves the right, at its sole discretion, to
      ...
      <View style={styles.loginInputsContainer}>
        <TextInput
          style={[
            loginFailed ? styles.loginInputsFailed : styles.loginInputs,
            {color: '#000'},
          ]}
          placeholder="Email"
          onChangeText={(text) => {
        ...
        />
        {loginFailed ? (
          <Text style={{color: '#FF0000', fontSize: 10, paddingLeft: 10}}>
