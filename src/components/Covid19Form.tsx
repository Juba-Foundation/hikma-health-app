...
const formatTravel = (metadataObj, language) => {
  if (!!metadataObj.travelDeparture && !!metadataObj.travelReturn) {
    return (
      metadataObj.travelDeparture +
      ' ' +
      LocalizedStrings[language].to +
      ' ' +
      metadataObj.travelReturn
    );
  }
  ...
  return (
    <View>
      <Text style={{fontWeight: 'bold'}}>
        {formatResult(metadataObj, language)}
      </Text>
      {!!metadataObj.fever ? (
        <Text>
          {LocalizedStrings[language].fever}: {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.dryCough ? (
        <Text>
          {LocalizedStrings[language].dryCough}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.diffBreathing ? (
        <Text>
          {LocalizedStrings[language].diffBreathing}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.soreThroat ? (
        <Text>
          {LocalizedStrings[language].soreThroat}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.nausea ? (
        <Text>
          {LocalizedStrings[language].nausea}: {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.symptomsDate ? (
        <Text>
          {LocalizedStrings[language].symptomsDate}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.chestPain ? (
        <Text>
          {LocalizedStrings[language].chestPain}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.confusion ? (
        <Text>
          {LocalizedStrings[language].confusion}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.bluish ? (
        <Text>
          {LocalizedStrings[language].bluish}: {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.fatigue ? (
        <Text>
          {LocalizedStrings[language].fatigue}: {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.aches ? (
        <Text>
          {LocalizedStrings[language].aches}: {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.headache ? (
        <Text>
          {LocalizedStrings[language].headache}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.changeTasteSmell ? (
        <Text>
          {LocalizedStrings[language].changeTasteSmell}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.diabetes ? (
        <Text>
          {LocalizedStrings[language].diabetes}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.cardioDisease ? (
        <Text>
          {LocalizedStrings[language].cardioDisease}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.pulmonaryDisease ? (
        <Text>
          {LocalizedStrings[language].pulmonaryDisease}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.renalDisease ? (
        <Text>
          {LocalizedStrings[language].renalDisease}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.malignancy ? (
        <Text>
          {LocalizedStrings[language].malignancy}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.pregnant ? (
        <Text>
          {LocalizedStrings[language].pregnant}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.immunocompromised ? (
        <Text>
          {LocalizedStrings[language].immunocompromised}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.exposureKnown ? (
        <Text>
          {LocalizedStrings[language].exposureKnown}:{' '}
          {LocalizedStrings[language].yes}
        </Text>
      ) : null}
      {!!metadataObj.travel ? (
        <Text>
          {LocalizedStrings[language].travel}:{' '}
          {formatTravel(metadataObj, language)}
        </Text>
      ) : null}
    </View>
  );
        ...
        <View style={[styles.inputsContainer, {alignItems: 'flex-start'}]}>
          <View style={styles.responseRow}>
            {radioButtons({
              field: chestPain,
              action: setChestPain,
              prompt: LocalizedStrings[language].chestPain,
              language,
            })}
          </View>
          <View style={styles.responseRow}>
            {radioButtons({
              field: confusion,
              action: setConfusion,
              prompt: LocalizedStrings[language].confusion,
              language,
            })}
          </View>
          <View style={styles.responseRow}>
            {radioButtons({
              field: bluish,
              action: setBluish,
              prompt: LocalizedStrings[language].bluish,
              language,
            })}
          </View>
          <View style={styles.responseRow}>
            {radioButtons({
              field: fever,
              action: setFever,
              prompt: LocalizedStrings[language].fever,
              language,
            })}
          </View>
          <View style={styles.responseRow}>
            {radioButtons({
              field: dryCough,
              action: setDryCough,
              prompt: LocalizedStrings[language].dryCough,
              language,
            })}
          </View>
          <View style={styles.responseRow}>
            {radioButtons({
              field: diffBreathing,
              action: setDiffBreathing,
              prompt: LocalizedStrings[language].diffBreathing,
              language,
            })}
          </View>
          <View style={styles.responseRow}>
            {radioButtons({
              field: soreThroat,
              action: setSoreThroat,
              prompt: LocalizedStrings[language].soreThroat,
              language,
            })}
          </View>
          <View style={styles.responseRow}>
            {radioButtons({
              field: nausea,
              action: setNausea,
              prompt: LocalizedStrings[language].nausea,
              language,
            })}
          </View>
          <View style={styles.responseRow}>
            {radioButtons({
              field: fatigue,
              action: setFatigue,
              prompt: LocalizedStrings[language].fatigue,
              language,
            })}
          </View>
          <View style={styles.responseRow}>
            {radioButtons({
              field: aches,
              action: setAches,
              prompt: LocalizedStrings[language].aches,
              language,
            })}
          </View>
          <View style={styles.responseRow}>
            {radioButtons({
              field: headache,
              action: setHeadache,
              prompt: LocalizedStrings[language].headache,
              language,
            })}
          </View>
          <View style={styles.responseRow}>
            {radioButtons({
              field: changeTasteSmell,
              action: setChangeTasteSmell,
              prompt: LocalizedStrings[language].changeTasteSmell,
              language,
            })}
          </View>
          <View style={styles.responseRow}>
            {datePicker({
              placeholder: LocalizedStrings[language].symptomsDate,
              date: symptomsDate,
              action: setSymptomsDate,
            })}
          </View>
          ...
          >
            <Text style={styles.text}>
              {isCollapsed
                ? LocalizedStrings[language].riskFactors
                : LocalizedStrings[language].hideRiskFactors}
            </Text>
            <Image
            ...
            <View style={{width: '100%'}}>
              <View style={styles.responseRow}>
                {radioButtons({
                  field: diabetes,
                  action: setDiabetes,
                  prompt: LocalizedStrings[language].diabetes,
                  language,
                })}
              </View>
              <View style={styles.responseRow}>
                {radioButtons({
                  field: cardioDisease,
                  action: setCardioDisease,
                  prompt: LocalizedStrings[language].cardioDisease,
                  language,
                })}
              </View>
              <View style={styles.responseRow}>
                {radioButtons({
                  ...
                  action: setPulmonaryDisease,
                  prompt: LocalizedStrings[language].pulmonaryDisease,
                  language,
                })}
              </View>
              <View style={styles.responseRow}>
                {radioButtons({
                  field: renalDisease,
                  action: setRenalDisease,
                  prompt: LocalizedStrings[language].renalDisease,
                  language,
                })}
              </View>
              <View style={styles.responseRow}>
                {radioButtons({
                  field: malignancy,
                  action: setMalignancy,
                  prompt: LocalizedStrings[language].malignancy,
                  language,
                })}
              </View>
              <View style={styles.responseRow}>
                {radioButtons({
                  field: pregnant,
                  action: setPregnant,
                  prompt: LocalizedStrings[language].pregnant,
                  language,
                })}
              </View>
              <View style={styles.responseRow}>
                {radioButtons({
                  ...
                  action: setImmunocompromised,
                  prompt: LocalizedStrings[language].immunocompromised,
                  language,
                })}
              </View>
              <View style={[styles.responseRow]}>
                {radioButtons({
                  field: exposureKnown,
                  action: setExposureKnown,
                  prompt: LocalizedStrings[language].exposureKnown,
                  language,
                })}
              </View>
              <View style={styles.responseRow}>
                {radioButtons({
                  field: travel,
                  action: setTravel,
                  prompt: LocalizedStrings[language].travel,
                  language,
                })}
              </View>
              <View style={styles.responseRow}>
                <View style={{paddingLeft: 20}}>
                  {travel
                    ? datePicker({
                        placeholder: LocalizedStrings[language].departure,
                        date: travelDeparture,
                        action: setTravelDeparture,
                      })
                    : null}
                </View>
                {travel ? (
                ...
                <View style={{paddingLeft: 20}}>
                  {travel
                    ? datePicker({
                        placeholder: LocalizedStrings[language].return,
                        date: travelReturn,
                        action: setTravelReturn,
                      })
                    : null}
                </View>
              </View>
